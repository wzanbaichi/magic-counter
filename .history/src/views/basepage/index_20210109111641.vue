  ...
  <div id="container">
    <div class="menu">
      ...
      >
        ...
        ><i class="icon icon-bar-chart-2"></i>概况统计</at-menu-item>
        <at-menu-item
          v-if="fileFigureOut"
          name="Performance"
        ><i class="icon icon-award"></i>业绩统计</at-menu-item>
        <at-menu-item
          v-if="fileFigureOut"
          name="Resources"
        ><i class="icon icon-pie-chart"></i>资源分析</at-menu-item>
        <at-menu-item name="Help"><i class="icon icon-pie-chart"></i>表格规范</at-menu-item>
      </at-menu>
