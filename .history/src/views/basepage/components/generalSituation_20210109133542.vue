        ...
        month => {
          ...
          this.monthDetailData[month].forEach(
            row => {
              ...
              // data[month].revenue += data[month].revenue + parseFloat(row.bqk) || 0 + parseFloat(row.qk) || 0 - parseFloat(row.zcje) || 0 + parseFloat(row.zrje) || 0 - parseFloat(row.tfje) || 0
              data[month].revenue += (data[month].revenue + (parseFloat(row.qk) || 0))
              console.log(data[month].revenue)
            }
          )
        }
      )
