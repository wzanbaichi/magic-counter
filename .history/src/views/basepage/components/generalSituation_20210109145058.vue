...
export default {
  ...
  methods: {
    ...
    countQkAndBqkData() {
      ...
      console.log(zrjeData)
      this.qkAndBqkSum = qkAndBqkData.reduce((prev, next, index, ary) => prev + next).toFixed(2)
      this.tfjeSum = tfjeData.reduce((prev, next, index, ary) => prev + next).toFixed(2)
      this.revenueSum = revenueData.reduce((prev, next, index, ary) => prev + next).toFixed(2)
      this.zcjeSum = zcjeData.reduce((prev, next, index, ary) => prev + next).toFixed(2)
      this.zrjeSum = zrjeData.reduce((prev, next, index, ary) => prev + next).toFixed(2)
