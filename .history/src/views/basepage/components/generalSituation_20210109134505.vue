        ...
        month => {
          ...
          this.monthDetailData[month].forEach(
            row => {
              ...
              if (row.tfje) {
                data[month].tuifeiData.push(row.tfje)
              }
              data[month].revenue += Math.abs(row.bqk) || 0 + Math.abs(row.qk) || 0 - Math.abs(row.zcje) || 0 + Math.abs(row.zrje) || 0 - Math.abs(row.tfje) || 0
              data[month].tfje += Math.abs(row.bqk) || 0 + Math.abs(row.qk) || 0 - Math.abs(row.zcje) || 0 + Math.abs(row.zrje) || 0 - Math.abs(row.tfje) || 0
            }
          )
        }
      )
